...
class Bungalow(db.Model):
    ...
    reservations = db.relationship('Reservation', backref='Bungalow', lazy=True, cascade="all,delete")
...
class User(UserMixin, db.Model):
    ...
    reservations = db.relationship('Reservation', backref='User', lazy=True, cascade="all,delete")
    created_at = db.Column(db.Date(), nullable=False, default=datetime.now())
    updated_at = db.Column(db.Date(), nullable=True)
    deleted_at = db.Column(db.Date(), nullable=True)
